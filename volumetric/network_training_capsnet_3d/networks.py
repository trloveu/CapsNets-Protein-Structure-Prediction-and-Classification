...
from keras.layers import Conv2D, Conv3D, Input, Dense, Reshape, Dropout, Add
...
def CAPSNET(args, nb_class):
    ...
    input_shape = (64, 64, 64, args.nb_chans)

    x = Input(shape = input_shape)

    # Layer 1: Conv2D layer
    conv1 = Conv3D(filters = args.filters, kernel_size = args.kernel_size, strides = args.strides, padding = 'valid', activation = 'relu', name = 'conv1')(x)
